...
import { Users, BookOpen, Lightbulb, Rocket, Target, Heart, LucideIcon } from "lucide-react";
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3
                        className={`
                        heading-tertiary md:mt-4 lg:mt-0 mb-2 transition-colors duration-300
                        ${
                          isActive
                            ? "text-gray-900"
                            : "text-gray-700"
                      ...
                      <p
                        className={`
                        transition-colors duration-300 text-gray-700
                        ${
                          isActive
                            ? ""
                            : "text-gray-600"
